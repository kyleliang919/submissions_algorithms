...
<!-- TODO: Possibly add proper citation for each submission? -->
...
| 6.       | <details><summary>***Baseline***</summary>Baseline using NadamW ([Dozat, 2016](https://openreview.net/forum?id=OM0jvwB8jIp57ZJjtNEZ); [Loshchilov & Hutter, 2019](https://openreview.net/forum?id=Bkg6RiCqY7)) and a linear learning rate warmup follwed by a cosine decay ([Dahl et al., 2023](https://arxiv.org/abs/2306.07179)).</details>            |                                                                                                                      |                                  | JAX           | **0.5707** |
...
| 2.       | <details><summary>***Baseline***</summary>Baseline using NadamW, a linear learning rate warmup follwed by a cosine decay, and a single hyperparameter point ([Dahl et al., 2023](https://arxiv.org/abs/2306.07179)).</details>          |                                                                                                                      |                            | JAX           | **0.8194** |
